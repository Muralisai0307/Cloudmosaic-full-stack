...
function Home() {
  ...
  const handleQuizEmailSubmit = async (e) => {
    ...
    try {
      ...
      if (err.errors && Object.keys(err.errors).length > 0) {
        ...
        error(`Failed to send: ${errorMsgs}`);
      } else {
  ...
  const schemaMarkup = {
    ...
    "@type": "Organization",
    "name": "CloudMosaic",
    "url": "https://cloudmosaic.ai",
    "logo": "https://cloudmosaic.ai/images/logo.png",
    "contactPoint": {
      "@type": "ContactPoint",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://cloudmosaic.ai" />
        ...
        <meta property="og:image" content="https://cloudmosaic.ai/images/logo.png" />
        <meta property="og:url" content="https://cloudmosaic.ai" />
        ...
        <meta name="twitter:image" content="https://cloudmosaic.ai/images/logo.png" />
